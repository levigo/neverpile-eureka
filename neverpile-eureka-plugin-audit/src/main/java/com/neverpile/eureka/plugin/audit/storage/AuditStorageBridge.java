...
/**
 * This interface allows the audit plugin to use a variaty of storage mediums depending on the timplementation.
...
public interface AuditStorageBridge {
   ...
   *
   * @param auditId the audit event ID to retrieve the Auditevent for.
   ...
   *
   * @param key A unique objectName as a key for the requestd audit verification data.
  ...
  /**
   * Update the Current Verification Head of the undelying verification structure.
  ...
  /**
   * Update the Current Verification Head of the undelying verification structure.
   * This head value has to be updated depending on the implementation to ensure new data can be appended consisantly.
   *
